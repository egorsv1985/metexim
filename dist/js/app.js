(() => {
  ...
  window.addEventListener("scroll", () => {
    ...
    e <= 0
      ? re.classList.remove(ne)
      : (e > ae && !re.classList.contains(oe)
          ? (re.classList.remove(ne), re.classList.add(oe))
          : e < ae &&
            re.classList.contains(oe) &&
            (re.classList.remove(oe), re.classList.add(ne)),
        (ae = e));
  });
})();
